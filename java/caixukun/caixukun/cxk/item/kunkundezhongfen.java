...
public class kunkundezhongfen extends ArmorItem {


    public kunkundezhongfen() {
        super(ModArmorMaterial.CXK, EquipmentSlotType.HEAD, new Properties().group(CXKItemGroup.CXK_ITEM_GROUP));
    }
    ...
    public static class GlobalTrigger {
        ...
        public static void onEntityAttacked(LivingAttackEvent event) {
            ...
            if(entity instanceof LivingEntity) {
                ...
                if (((LivingEntity) entity).getItemStackFromSlot(EquipmentSlotType.HEAD).getItem() == CXKItemReg.zhongfen.get()) {
