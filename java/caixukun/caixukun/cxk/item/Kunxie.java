...
public class Kunxie extends ArmorItem {
    public Kunxie() {
        super(ModArmorMaterial.CXK, EquipmentSlotType.FEET, new Properties().group(CXKItemGroup.CXK_ITEM_GROUP));
    }
    ...
    public static class GlobalTrigger {
        ...
        public static void onEntityAttacked(LivingAttackEvent event) {
            ...
            if(entity instanceof LivingEntity) {
                ...
                if (((LivingEntity) entity).getItemStackFromSlot(EquipmentSlotType.FEET).getItem() == CXKItemReg.kunxie.get()) {
