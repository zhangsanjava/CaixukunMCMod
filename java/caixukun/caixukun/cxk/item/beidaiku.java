...
public class beidaiku extends ArmorItem {
    public beidaiku() {
        super(ModArmorMaterial.CXK, EquipmentSlotType.LEGS, new Properties().group(CXKItemGroup.CXK_ITEM_GROUP));
    }
    ...
    public static class GlobalTrigger {
        ...
        public static void onEntityAttacked(LivingAttackEvent event) {
            ...
            if(entity instanceof LivingEntity) {
                //oSystem.out.println("LivingEntity");
                if (((LivingEntity) entity).getItemStackFromSlot(EquipmentSlotType.LEGS).getItem() == CXKItemReg.beidaiku.get()) {
